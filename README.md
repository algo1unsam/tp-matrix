...
El objetivo es desarrollar y probar un programa con la técnica **TDD** ([Test Driven Development](https://es.wikipedia.org/wiki/Desarrollo_guiado_por_pruebas), primero escribís los tests y después el código) que los hace pasar. )que permita saber si un paquete puede ser entregado por un mensajero.  
